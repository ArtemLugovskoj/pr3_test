function generateLog({ name: charName, damageHP: charDamageHP, defaultHP: charDefaultHP }, { name: enemyName }, damage) {
    const logs = [
    ...
    const lossInfo = `Завдано втрат: ${damage}, осталось HP: ${charDamageHP}/${charDefaultHP}`;
